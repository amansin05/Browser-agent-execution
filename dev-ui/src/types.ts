...
export type AgentEvent =
  ...
  | { type: "step"; step: number; thought?: string; action: string; args: unknown }
  | { type: "extract"; step: number; chars?: number }
  | { type: "grounding"; text: string }
  | { type: "action_result"; action: string; outcome: string; blocked?: boolean }
  ...
  | { type: "candidates"; id: number; count: number; candidates: Record<string, unknown>[] }
